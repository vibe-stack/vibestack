            ...
            <TabsContent value="scene" className="flex-1 p-0 m-0 w-full mt-2">
              ...
              {selectedNode ? (
                <Tabs defaultValue="hierarchy" className="flex-1 w-full">
                  ...
                  <TabsContent value="hierarchy" className="flex-1 p-0 m-0 w-full mt-2">
                  ...
                  <TabsContent value="inspector" className="flex-1 p-0 m-0 w-full mt-2">
                    <div className="bg-zinc-900/30 rounded-xl overflow-hidden">
            ...
            <ResizablePanel defaultSize={50} className="flex flex-col">
              <Tabs defaultValue="preview" className="flex-1 flex flex-col">
                <TabsList className="justify-start bg-zinc-900/30 rounded-xl w-fit">
                  <TabsTrigger value="preview" className="flex items-center rounded-lg">
                    <Play className="h-4 w-4 mr-2" />
                    Preview
                  </TabsTrigger>
                  <TabsTrigger value="code" className="flex items-center rounded-lg">
        ...
        >
          ...
          <ScrollArea className="h-full">
            <div className="p-4 space-y-6">
              <div>
                <h3 className="font-medium mb-3 text-sm text-zinc-400 tracking-wide">PROJECT</h3>
              ...
              <div>
                <h3 className="font-medium mb-3 text-sm text-zinc-400 tracking-wide">GAME</h3>
                <div className="space-y-1">
                  <Button variant="ghost" size="sm" className="w-full justify-start rounded-lg">
